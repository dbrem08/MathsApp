package stealthness.com.tokens.numbertokens;
...
import stealthness.com.tokens.CharToken;
import stealthness.com.tokens.DataToken;
import stealthness.com.tokens.NumberToken;
import stealthness.com.tokens.LogicalToken;
...
{            
    ...
    public String toString(double _values[])
    {
        ...
        if (re == Double.POSITIVE_INFINITY)
            ...
            result.append(stealthness.com.interpreter.GlobalValues.numFormat.format(re));
        ...
        if((im != 0.0) || Double.isNaN(im))
        {
            ...
            if (im == Double.POSITIVE_INFINITY)
                ...
                result.append(stealthness.com.interpreter.GlobalValues.numFormat.format(im));
