...
/*               //display currently parse line of code to display
     ...
     * @throws Exception 
     */
    public double getScalarValueRe(String name) throws Exception
    {
            // get variable from variable list
    	try {
    		Exception e = new Exception("error");
			if (globals ==  null) throw (e ) ;
	        ...
	        if (!(variableData instanceof stealthness.com.tokens.DoubleNumberToken)) return 0.0;
