package stealthness.com.interpreter;
...
import stealthness.com.functions.FunctionManager;
...
public class GlobalValues
{
    ...
    private stealthness.com.functions.FunctionManager functionManager;
    ...
    private stealthness.com.plugins.PluginsManager pluginsManager;     
    ...
    public GlobalValues(Interpreter _interpreter, boolean _runningStandalone)
    {
        ...
        functionManager = new FunctionManager(_runningStandalone);
        ...
        pluginsManager = new stealthness.com.plugins.PluginsManager();
     ...
     */
    public stealthness.com.functions.FunctionManager getFunctionManager()
    {
     ...
     */
    public stealthness.com.plugins.PluginsManager getPluginsManager()
    {
